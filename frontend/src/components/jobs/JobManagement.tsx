      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {jobs.map((job) => (
            <div
              key={job.id}
              className="card-3d card-3d-hover p-5 space-y-4 flex flex-col justify-between"
            >
              ...
              <div className="pt-4 border-t border-[#eff4ff] flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-xs font-extrabold text-[#006c49] hover:underline flex items-center gap-1"
                >
